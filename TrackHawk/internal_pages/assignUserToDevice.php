<?php
	...
	if($row==null){
		...
		$result=mysqli_query($con,"insert into deviceholders values('$imei','$name','$phone','$date','$devicename',$highway,'2222-12-12 00:00:00')");
	...
	$result=mysqli_query($con,"update devices set currentholder='$name',currentnum='$phone',highway=$highway,status=1 where imei='$imei'");
	echo  "<script type='text/javascript'>";
		echo "window.close();";
		echo "</script>";
}
